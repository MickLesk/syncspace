<script>
  ...
  onMount(() => {
    ...
    const unsubscribeStorage = storageStats.subscribe(
      (s) => (storageStatistics = s)
    );
...
<div class="admin-console h-screen flex flex-col bg-gray-50 dark:bg-gray-900">
  ...
  >
    ...
    <div class="px-6 border-t border-gray-200 dark:border-gray-700 flex gap-8">
      ...
      >
        <i class="bi bi-people" aria-hidden="true"></i> Users ({userStatistics.total ||
          0})
      </button>
  ...
  <div class="flex-1 overflow-y-auto">
    {#if activeTab === "users"}
      ...
      <div class="p-6">
        ...
        {#if selectedUsers.size > 0}
          <div
            class="mb-4 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg flex justify-between items-center"
          >
            <span
    ...
    {:else if activeTab === "roles"}
      ...
      <div class="p-6">
        <p class="text-gray-600 dark:text-gray-400">
          Roles management UI - coming soon
        </p>
      </div>
        ...
        >
          <table class="w-full text-sm">
            ...
            >
              <tr>
                <th
                  class="px-6 py-3 text-left font-semibold text-gray-700 dark:text-gray-300"
                  >Time</th
                >
                <th
                  class="px-6 py-3 text-left font-semibold text-gray-700 dark:text-gray-300"
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
              {storageStatistics.percentage || 0}% of {Math.round(
                (storageStatistics.limit || 0) / 1000000
              )} MB
            </p>
          </div>
        </div>
              ...
              <div>
                <div class="flex justify-between mb-1">
                  ...
                  <span class="text-sm text-gray-600 dark:text-gray-400">
                    {Math.round(userStorage.used / 1000000)} / {Math.round(
                      userStorage.limit / 1000000
                    )} MB
                  </span>
                </div>
                <div
