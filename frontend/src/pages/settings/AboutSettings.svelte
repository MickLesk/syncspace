  ...
  <div class="glass-card p-8 animate-slide-up">
    ...
    <div class="text-center mb-8">
      <div class="logo-circle mx-auto mb-6">
        <i class="bi bi-cloud-fill text-5xl"></i>
      </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
      ...
      <div
        class="text-center p-4 bg-gradient-to-br from-pink-50 to-pink-100 dark:from-pink-900/20 dark:to-pink-800/20 rounded-xl border border-pink-200 dark:border-pink-800"
      >
        <div
    ...
    <div class="grid grid-cols-2 gap-3">
      ...
      <button
        class="px-4 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold rounded-xl shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 transition-all duration-200 flex items-center justify-center gap-2 group"
      >
        <i class="bi bi-book text-lg group-hover:scale-110 transition-transform"
        ></i>
