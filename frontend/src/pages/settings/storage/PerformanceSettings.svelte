...
<div class="flex flex-col gap-6">
  ...
  {:else if performanceData}
    ...
    <div class="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-4">
      <div
        class="bg-gradient-to-br from-base-100/80 to-base-100/40 rounded-xl backdrop-blur-xl shadow-[0_4px_12px_rgba(0,0,0,0.08)] hover:shadow-[0_8px_24px_rgba(34,197,94,0.15)] transition-all p-5 flex flex-col gap-3"
      >
        <div class="flex items-center gap-3">
          <div
            class="w-10 h-10 rounded-lg flex items-center justify-center text-xl bg-success/20 text-success"
          >
            <i class="bi bi-cpu"></i>
          </div>
          <div class="flex flex-col">
            <span class="text-2xl font-bold text-base-content"
              >{performanceData.cpu_usage}%</span
            >
      ...
      >
        <div class="flex items-center gap-3">
          <div
            class="w-10 h-10 rounded-lg flex items-center justify-center text-xl bg-info/20 text-info"
          >
            <i class="bi bi-memory"></i>
          </div>
          <div class="flex flex-col">
            <span class="text-2xl font-bold text-base-content"
              >{performanceData.memory_usage}%</span
            >
            <span class="text-xs text-base-content/60"
              >{tr("settings.performance.memory")}</span
            >
          </div>
        </div>
        <div class="h-1.5 bg-base-300 rounded-full overflow-hidden">
      ...
      >
        <div class="flex items-center gap-3">
          <div
            class="w-10 h-10 rounded-lg flex items-center justify-center text-xl bg-warning/20 text-warning"
          >
            <i class="bi bi-hdd"></i>
          </div>
          <div class="flex flex-col">
            <span class="text-2xl font-bold text-base-content"
              >{performanceData.disk_usage}%</span
            >
            <span class="text-xs text-base-content/60"
              >{tr("settings.performance.disk")}</span
            >
          </div>
        </div>
        <div class="h-1.5 bg-base-300 rounded-full overflow-hidden">
      ...
      >
        <div class="flex items-center gap-3">
          <div
            class="w-10 h-10 rounded-lg flex items-center justify-center text-xl bg-violet-500/20 text-violet-500"
          >
          ...
          <div class="flex flex-col">
            ...
            >
            <span class="text-xs text-base-content/60"
              >{tr("settings.performance.uptime")}</span
            >
          </div>
        </div>
      </div>
    ...
    >
      <div class="flex items-center gap-4 p-5 border-b border-base-300">
        <div
          class="w-9 h-9 rounded-lg flex items-center justify-center text-lg bg-success/20 text-success shrink-0"
        >
          <i class="bi bi-speedometer2"></i>
        </div>
        <div>
          <h3 class="text-base font-semibold text-base-content m-0">
            {tr("settings.performance.metrics")}
          </h3>
          <p class="text-xs text-base-content/60 mt-1 mb-0">
            {tr("settings.performance.metrics_desc")}
          </p>
        </div>
      </div>
      ...
      <div class="p-5">
        <div class="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-4">
          ...
          <div class="flex flex-col gap-1 p-3 bg-base-200 rounded-lg">
            ...
            >
            <span class="text-sm font-semibold text-base-content"
              >{performanceData.cache_hit_rate}%</span
            >
          </div>
    ...
    >
      <div class="flex items-center gap-4 p-5 border-b border-base-300">
        <div
          class="w-9 h-9 rounded-lg flex items-center justify-center text-lg bg-info/20 text-info shrink-0"
        >
          <i class="bi bi-tools"></i>
        </div>
        <div>
          <h3 class="text-base font-semibold text-base-content m-0">
            {tr("settings.performance.maintenance")}
          </h3>
          <p class="text-xs text-base-content/60 mt-1 mb-0">
      ...
      <div class="p-5">
        <div class="grid grid-cols-[repeat(auto-fit,minmax(220px,1fr))] gap-4">
          <button
            class="flex items-center gap-4 p-4 bg-base-200 border border-base-300 rounded-lg cursor-pointer transition-all text-left hover:bg-base-100 hover:border-primary hover:shadow-sm"
            onclick={clearCache}
          >
            <div
