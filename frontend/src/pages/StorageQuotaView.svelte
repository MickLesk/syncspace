  ...
  {:else if $storageQuota.error}
    <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-lg p-4 mb-6">
      <div class="flex items-center">
        <i class="bi bi-exclamation-circle text-red-600 dark:text-red-400 mr-3" aria-hidden="true"></i>
  ...
  {:else}
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
      ...
      <div class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-900/10 rounded-lg p-4 border border-purple-200 dark:border-purple-700">
        ...
        <div class="flex items-center">
          <i class="bi bi-circle-fill text-xl mr-2" class:text-green-500={$storageStatus === 'success'} class:text-yellow-500={$storageStatus === 'warning'} class:text-red-500={$storageStatus === 'danger'} aria-hidden="true"></i>
        ...
        <div class="space-y-3">
          {#each $storageQuota.byFolder as folder}
            <div class="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
              <div class="flex items-center justify-between mb-2">
                <div class="flex items-center">
                  <i class="bi bi-folder-fill text-yellow-500 mr-3 text-lg" aria-hidden="true"></i>
                  <div>
