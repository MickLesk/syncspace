    ...
    <form onsubmit={handleSubmit} class="space-y-4">
      ...
      <div class="form-control">
        ...
        <input
          id="cron-expr"
          type="text"
          class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 font-mono focus:ring-2 focus:ring-green-500 focus:border-transparent"
