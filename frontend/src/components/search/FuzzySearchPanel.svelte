  ...
  <div class="flex gap-2">
    <div class="flex-1 relative">
      <input
        ...
        bind:value={query}
        class="w-full px-4 py-2 rounded-lg border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:border-blue-500 focus:outline-none"
      />
      {#if isSearching}
  ...
  <div class="flex gap-2 flex-wrap">
    ...
    {#if query.trim()}
      <div class="text-sm text-gray-600 dark:text-gray-400">
        {displayResults.length} {tr("results")}
      </div>
    {/if}
  </div>
