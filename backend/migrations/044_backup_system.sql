...
-- Migration: 044_backup_system
-- Description: Comprehensive backup and restore system (drops and recreates for clean schema)

-- Drop all backup-related tables to ensure clean schema
DROP TABLE IF EXISTS backup_encryption_keys;
DROP TABLE IF EXISTS backup_dedup_blocks;
